...
DEF("bitmap", img_bitmap,
    "bitmap <dump|clear|rm> [--object objectdef] [--image-opts] [-f fmt] [--output=ofmt] [-U] filename [bitmap]")
STEXI
@item bitmap <dump|clear|rm> [--object @var{objectdef}] [--image-opts] [-f @var{fmt}] [--output=@var{ofmt}] [-U] @var{filename} [@var{bitmap}]
ETEXI
